        ...
        <div class="images">
            <div class="menu-img1">
                ...
                <div class="menu-img1text"> 
                    <h2><a href="Unagi.php">Unagi</a></h2> 
                </div>
            </div>
            <div class="menu-img2">
                <div>
                ...
                <div class="menu-img2text">
                    <h2><a href="sushi.php">Sushi</a></h2> 
                </div>
            </div>
            <div class="menu-img3">
                <div>
                ...
                <div class="menu-img3text"> 
                    <h2><a href="tempura.php">Tempura</a></h2>
                </div>
            </div>
            <div class="menu-img4">
                <div>
            ...
            <div class="menu-img6">
                ...
                <div class="menu-img6text">
                    <h2><a href="Onigiri.php">Onigiri</a></h2>
                </div>
            </div>
        </div>
