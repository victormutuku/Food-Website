...
<head>
    ...
    <body>
        <div class="first">
            ...
            <a href="../Pages/Menu.php"><h1 class="menu">Unagi:</h1></a>
            <?php
            ...
            <div class="images">
                <?php
                    ...
                    foreach($fetchedunagi as $key => $value){
                ?>
                <div class="specific">
                    <div>
                        <img src="<?php echo $value["imagepathname"]?>" class="specific-img">
                        <a href="cart.php?GETID=<?php echo $value["food_id"]?>" name="cart"><h2><?php echo $value["fooditem"]?></h2></a>
